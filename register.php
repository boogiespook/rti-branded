      ...
      <nav class="navbar navbar-default" role="navigation">
         <div class="container-fluid">
            <div class="inner-wrapper">
               <div class="grid">
                  <div class="xl-colspan-10 l-colspan-9 s-colspan-8">
                     <!-- add header -->
                  ...
                  <div class="xl-colspan-2 l-colspan-3 s-colspan-4">
                     <!-- menu items -->
                     <div id="navbar1">
               ...
               <fieldset>
                  ...
                  <div class="form-group">
                     ...
                     <select name="register_country" class="form-control" style="border-radius: 0;">
                        <option value="" style="font-family: 'overpass';">- Please select -</option>
